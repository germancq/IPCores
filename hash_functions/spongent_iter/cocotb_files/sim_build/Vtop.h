...
VL_MODULE(Vtop) {
  public:
    ...
    struct {
        ...
        WData/*223:0*/ spongent_iter__DOT__digest[7];
        WData/*239:0*/ spongent_iter__DOT__permutation_state[8];
        WData/*239:0*/ spongent_iter__DOT__permutation_initial_state[8];
        WData/*239:0*/ spongent_iter__DOT__permutation_initial_state_from_squezzing[8];
        WData/*239:0*/ spongent_iter__DOT__permutation_initial_state_from_absorb[8];
        WData/*239:0*/ spongent_iter__DOT__state[8];
        WData/*239:0*/ spongent_iter__DOT__standart_initial_state_from_absorb[8];
        WData/*239:0*/ spongent_iter__DOT__last_initial_state_from_absorb[8];
        WData/*239:0*/ spongent_iter__DOT__permutation_impl__DOT__initial_state[8];
        WData/*239:0*/ spongent_iter__DOT__permutation_impl__DOT__state[8];
        WData/*239:0*/ spongent_iter__DOT__permutation_impl__DOT__state_reg[8];
        WData/*239:0*/ spongent_iter__DOT__permutation_impl__DOT__state_S_box[8];
        WData/*239:0*/ spongent_iter__DOT__permutation_impl__DOT__pLayer_impl__DOT__din[8];
    };
    struct {
        WData/*239:0*/ spongent_iter__DOT__permutation_impl__DOT__pLayer_impl__DOT__dout[8];
        WData/*239:0*/ spongent_iter__DOT__squeezing_phase_impl__DOT__permutation_state[8];
        WData/*239:0*/ spongent_iter__DOT__squeezing_phase_impl__DOT__permutation_initial_state[8];
        WData/*223:0*/ spongent_iter__DOT__squeezing_phase_impl__DOT__result[7];
        WData/*239:0*/ spongent_iter__DOT__squeezing_phase_impl__DOT__state[8];
    };
    ...
    static CData/*1:0*/ __Vtable61_spongent_iter__DOT__squeezing_phase_impl__DOT__next_state[16];
    static CData/*0:0*/ __Vtable61_spongent_iter__DOT__squeezing_phase_impl__DOT__rst_permutation[16];
    static CData/*0:0*/ __Vtable61_spongent_iter__DOT__squeezing_phase_impl__DOT__counter_up[16];
