...
abs_path_file_storage = "/home/germancq/gitProjects/IPCores/stream_ciphers/trivium_cipher/python_code/test_cases.HEX"
...
def create_microsd_vectors(micro_sd,storage_file,N,e):
    ...
    for i in range(0,N):
        ...
        expected_value = trivium.trivium_impl(key[0],iv[0],64)
        ...
        storage_file.write(int(iv[0]).to_bytes(10, byteorder='little'))   
        storage_file.write(expected_value.to_bytes(8, byteorder='little'))   
        ...
        j=j+1
        micro_sd.write(SIGNATURE.to_bytes(4, byteorder='big'))
        micro_sd.write(int(iv[0]).to_bytes(10, byteorder='little'))
        micro_sd.write(int(key[0]).to_bytes(10, byteorder='little'))
        micro_sd.write(int(expected_value).to_bytes(8,byteorder='little'))
