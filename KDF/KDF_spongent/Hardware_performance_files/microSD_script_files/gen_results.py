...
def create_fields(sheet1):
    ...
    sheet1.write(0,2,'user_password')
    sheet1.write(0,3,'count')
    sheet1.write(0,4,'expected_value')
    sheet1.write(0,5,'ciphertext_400MHz')
    sheet1.write(0,6,'error_400MHz')
    sheet1.write(0,7,'HW_time_ns_400Mhz')
    sheet1.write(0,8,'ciphertext_200MHz')
    sheet1.write(0,9,'error_200MHz')
    sheet1.write(0,10,'HW_time_ns_200Mhz')
    sheet1.write(0,11,'ciphertext_100MHz')
    sheet1.write(0,12,'error_100MHz')
    sheet1.write(0,13,'HW_time_ns_100Mhz')
...
def write_params(sheet1, params , i):
    ...
    sheet1.write(i,5,hex(result_400))
    sheet1.write(i,6,hex(error_400))
    sheet1.write(i,7,hw_time_400)
    sheet1.write(i,8,hex(result_200))
    sheet1.write(i,9,hex(error_200))
    sheet1.write(i,10,hw_time_200)
    sheet1.write(i,11,hex(result_100))
    sheet1.write(i,12,hex(error_100))
    sheet1.write(i,13,hw_time_100)
