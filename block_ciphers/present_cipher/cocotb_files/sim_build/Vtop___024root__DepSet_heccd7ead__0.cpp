...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__4(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->present__DOT____Vcellinp__result__cl) {
        vlSelf->present__DOT__reg_end_signal__DOT__dout = 0U;
        vlSelf->present__DOT__result__DOT__dout = 0ULL;
    } else if (vlSelf->present__DOT____Vcellinp__result__w) {
        vlSelf->present__DOT__reg_end_signal__DOT__dout = 1U;
        vlSelf->present__DOT__result__DOT__dout = vlSelf->present__DOT__block_o_logic;
    }
    if (vlSelf->present__DOT__key_sch_impl__DOT__r_w) {
        __Vdlyvval__present__DOT__key_sch_impl__DOT__memory_impl__DOT__memory___v0 
            = (((QData)((IData)(vlSelf->present__DOT__key_sch_impl__DOT__key_register_output[2U])) 
                << 0x30U) | (((QData)((IData)(vlSelf->present__DOT__key_sch_impl__DOT__key_register_output[1U])) 
                              << 0x10U) | ((QData)((IData)(
    ...
    } else if (vlSelf->present__DOT__key_sch_impl__DOT__counter_up) {
        __Vdly__present__DOT__key_sch_impl__DOT__counter_impl__DOT__dout 
            = (0x1fU & ((IData)(1U) + (IData)(vlSelf->present__DOT__key_sch_impl__DOT__counter_impl__DOT__dout)));
    }
    if (vlSelf->present__DOT__key_sch_impl__DOT__key_register_cl) {
        vlSelf->present__DOT__key_sch_impl__DOT__key_register__DOT__dout[0U] = 0U;
        vlSelf->present__DOT__key_sch_impl__DOT__key_register__DOT__dout[1U] = 0U;
        vlSelf->present__DOT__key_sch_impl__DOT__key_register__DOT__dout[2U] = 0U;
    } else if (vlSelf->present__DOT__key_sch_impl__DOT__key_register_w) {
    ...
    vlSelf->present__DOT__key_sch_impl__DOT__current_state 
        = ((IData)(vlSelf->rst) ? 0U : (IData)(vlSelf->present__DOT__key_sch_impl__DOT__next_state));
    if (vlSelf->present__DOT____Vcellinp__present_enc_impl__rst) {
        vlSelf->present__DOT__present_enc_impl__DOT__end_signal = 0U;
        vlSelf->present__DOT__present_dec_impl__DOT__end_signal = 0U;
    } else {
        if ((0x1fU == (IData)(vlSelf->present__DOT__present_enc_impl__DOT__key_index))) {
            vlSelf->present__DOT__present_enc_impl__DOT__end_signal = 1U;
        } else if (vlSelf->present__DOT__start_enc) {
            vlSelf->present__DOT__present_enc_impl__DOT__end_signal = 0U;
        }
        if ((0U == (IData)(vlSelf->present__DOT__present_dec_impl__DOT__key_index))) {
            vlSelf->present__DOT__present_dec_impl__DOT__end_signal = 1U;
        } else if (vlSelf->present__DOT__start_dec) {
            vlSelf->present__DOT__present_dec_impl__DOT__end_signal = 0U;
        }
    }
    if (vlSelf->present__DOT__present_enc_impl__DOT____Vcellinp__counter_impl__rst) {
        vlSelf->present__DOT__present_enc_impl__DOT__block_register__DOT__dout = 0ULL;
    } else if (vlSelf->present__DOT__present_enc_impl__DOT__register_w) {
        vlSelf->present__DOT__present_enc_impl__DOT__block_register__DOT__dout 
            = vlSelf->present__DOT__present_enc_impl__DOT__block_o;
    }
    if (vlSelf->present__DOT__present_dec_impl__DOT____Vcellinp__counter_impl__rst) {
        vlSelf->present__DOT__present_dec_impl__DOT__block_register__DOT__dout = 0ULL;
    } else if (vlSelf->present__DOT__present_dec_impl__DOT__register_w) {
    ...
    } else if (vlSelf->present__DOT__present_enc_impl__DOT__counter_up) {
        __Vdly__present__DOT__present_enc_impl__DOT__counter_impl__DOT__dout 
            = (0x1fU & ((IData)(1U) + (IData)(vlSelf->present__DOT__present_enc_impl__DOT__counter_impl__DOT__dout)));
    }
    if (vlSelf->present__DOT__present_dec_impl__DOT____Vcellinp__counter_impl__rst) {
        __Vdly__present__DOT__present_dec_impl__DOT__counter_impl__DOT__dout = 0x1fU;
    } else if (vlSelf->present__DOT__present_dec_impl__DOT__counter_down) {
        __Vdly__present__DOT__present_dec_impl__DOT__counter_impl__DOT__dout 
            = (0x1fU & ((IData)(vlSelf->present__DOT__present_dec_impl__DOT__counter_impl__DOT__dout) 
                        - (IData)(1U)));
    }
    if ((1U & (~ (IData)(vlSelf->present__DOT__key_sch_impl__DOT__r_w)))) {
        vlSelf->present__DOT__key_sch_impl__DOT__memory_impl__DOT__dout 
            = vlSelf->present__DOT__key_sch_impl__DOT__memory_impl__DOT__memory_
            [vlSelf->present__DOT__key_sch_impl__DOT__mem_addr];
    }
    vlSelf->present__DOT__key_sch_impl__DOT__counter_impl__DOT__dout 
        = __Vdly__present__DOT__key_sch_impl__DOT__counter_impl__DOT__dout;
    ...
    if (__Vdlyvset__present__DOT__key_sch_impl__DOT__memory_impl__DOT__memory___v0) {
        vlSelf->present__DOT__key_sch_impl__DOT__memory_impl__DOT__memory_[__Vdlyvdim0__present__DOT__key_sch_impl__DOT__memory_impl__DOT__memory___v0] 
            = __Vdlyvval__present__DOT__key_sch_impl__DOT__memory_impl__DOT__memory___v0;
    }
    ...
    vlSelf->present__DOT__present_dec_impl__DOT__register_output 
        = vlSelf->present__DOT__present_dec_impl__DOT__block_register__DOT__dout;
    if ((1U & (~ (IData)(vlSelf->present__DOT____Vcellinp__present_enc_impl__rst)))) {
        if ((0x1fU == (IData)(vlSelf->present__DOT__present_enc_impl__DOT__key_index))) {
            vlSelf->present__DOT__present_enc_impl__DOT__counter_up = 0U;
        } else if (vlSelf->present__DOT__start_enc) {
            vlSelf->present__DOT__present_enc_impl__DOT__counter_up = 1U;
        }
        if ((0U == (IData)(vlSelf->present__DOT__present_dec_impl__DOT__key_index))) {
            vlSelf->present__DOT__present_dec_impl__DOT__counter_down = 0U;
        } else if (vlSelf->present__DOT__start_dec) {
            vlSelf->present__DOT__present_dec_impl__DOT__counter_down = 1U;
        }
    }
...
VL_INLINE_OPT void Vtop___024root___combo__TOP__5(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->enc_dec) {
        vlSelf->present__DOT__key_index = vlSelf->present__DOT__key_index_dec;
        vlSelf->present__DOT__block_o_logic = vlSelf->present__DOT__dec_o;
    } else {
        vlSelf->present__DOT__key_index = vlSelf->present__DOT__key_index_enc;
        vlSelf->present__DOT__block_o_logic = vlSelf->present__DOT__enc_o;
    }
...
void Vtop___024root___eval_debug_assertions(Vtop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->enc_dec & 0xfeU))) {
